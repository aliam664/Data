...
> برای افزودن آسان و اعتبارسنجی‌شده، ابتدا `catalog\UHM-Catalog-Manager.cmd` را اجرا کنید. ابزار Native اطلاعات را مرحله‌به‌مرحله دریافت و قبل از ذخیره با همین قواعد بررسی می‌کند. جزئیات: [راهنمای Catalog Manager](catalog-manager.md).
